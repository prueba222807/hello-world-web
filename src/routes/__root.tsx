...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ConTaxes Sales App — ERP comercial con Siigo" },
      { name: "description", content: "ERP comercial para gestión de ventas, pedidos y facturación electrónica con integración directa a Siigo." },
    ],
