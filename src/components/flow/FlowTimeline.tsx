...
import { EVENT_LABELS, ROLE_LABELS, formatDateTime, type OrderEventType } from "@/lib/order-flow";
import { MapPin, ImageIcon, PenLine } from "lucide-react";
...
export function FlowTimeline({ events, evidences, profiles }: { events: Evt[]; evidences: Evi[]; profiles: Record<string, Profile> }) {
